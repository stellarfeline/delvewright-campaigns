...
| `reference/` | the whole map: what the citadel is (`map-brief.md`), where the eight zones sit inside it (`map-zones.md`), and the multi-view reference sheet with the prompt and command that draw it |
